    ...
    function listDetailsTransaction($transactions)
    {
        try {
            $myArray = [
                ...
                'receiver_gender' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['gender'],
                'receiver_other_info' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['other_info'],
                'receiver_birthday' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['birthday'],
                'receiver_nationality' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['nationality'],
                'receiver_profession' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['profession'],
                'receiver_passport_ID' => Beneficiary::where('id_number', $transactions->receiver_beneficiary_id)->first()['passport_number'],
